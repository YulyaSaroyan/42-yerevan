...
int main() {
	...
	Cat catCopyConstructor(originalCat);

	std::cout << "[TEST] Constructor Copied Cat brain idea: "
			  << catCopyConstructor.getBrain()->getIdea(0) << std::endl;

	catCopyConstructor.getBrain()->setIdea(0, "Say Hi!");
